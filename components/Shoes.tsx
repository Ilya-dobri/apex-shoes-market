...
export const getAverageRating = (reviews: Review[] | undefined | null) => {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`absolute top-5  right-5 z-100 p-3 bg-white rounded-full shadow-md transition-colors ${
